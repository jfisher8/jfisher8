...
----
I'm a First-Class Honours University graduate working full-time in the Cyber Security industry and working on side projects as I go. My current area of interest programming-wise is Android development, working with the Flutter SDK and Dart language to build mobile apps for various purposes. I also have experience developing for the web, with PHP, HTML, & CSS being my main forte specifically. However, I have recently begun delving into the world of NextJS for web development.
